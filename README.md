...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/aus_local_gov/`
...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/aus_states_territories/`
...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/australia/`
...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/broadacre_regions/`
...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/NCRA_Marine_region/`
...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/ncra_regions/`
...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/NCRA_regions_coastal_waters_GDA94/`
...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/nrm_regions/`
...
`/g/data/jt48/aus-ref-clim-data-nci/shapefiles/data/river_regions/`
